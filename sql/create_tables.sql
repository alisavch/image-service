...
-- DROP TABLE IF EXISTS image_service.request;
-- DROP TABLE IF EXISTS image_service.user_image;
-- DROP TABLE IF EXISTS image_service.uploaded_image;
-- DROP TABLE IF EXISTS image_service.resulted_image;
-- DROP TABLE IF EXISTS image_service.user_account;
-- DROP TYPE IF EXISTS image_service.enum_status;
-- DROP TYPE IF EXISTS image_service.enum_service;
-- DROP TYPE IF EXISTS enum_status;
-- DROP TYPE IF EXISTS enum_service;
-- DROP SCHEMA IF EXISTS image_service;